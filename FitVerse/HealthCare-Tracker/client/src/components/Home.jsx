...
import { ArrowRight, Dumbbell, Salad, BarChart2, Brain, Bandage, Camera } from "lucide-react";
...
const Home = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      textColor: "text-yellow-950",
      bgColor: "bg-gradient-to-br from-blue-50 to-lime-100",
      icon: <Bandage size={28} />,
      link: "/exercisecard"
    }
  ];
      ...
      <footer className="relative z-10 px-6 py-8 border-t border-white/10 bg-black">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <img src={logo} className="w-10 mr-3" alt="FitVerse Logo" />
