...
import pull from "../../assets/pullup.gif"
    ...
    if (isTracking) {
      ...
      heartRateIntervalRef.current = setInterval(() => {
        ...
        if (exerciseIntensity > 0) {
          ...
          newRate = Math.min(180, heartRate + (exerciseIntensity * 4)); // Pull-ups are more intense than push-ups
        } else {
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-4 p-3 bg-blue-900/60 border border-blue-400/30 rounded-xl text-blue-200 text-center">
          <strong>Tip:</strong> Make sure your upper body is clearly visible in the camera, with good lighting. Face the camera and keep your arms and shoulders in the frame.
        </div>
